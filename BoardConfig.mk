...
DOLBY_VISION_MANIFEST := $(DEVICE_PATH)/hidl/dolby_vision.xml
ODM_MANIFEST_VILI_FILES := \
    $(NFC_MANIFEST) \
    $(DOLBY_VISION_MANIFEST)
ODM_MANIFEST_VILIIN_FILES := \
    $(NFC_MANIFEST) \
    $(DOLBY_VISION_MANIFEST)
ODM_MANIFEST_VILIGL_FILES := \
    $(NFC_MANIFEST) \
    $(DOLBY_VISION_MANIFEST)
ODM_MANIFEST_VILIJP_FILES := \
    $(NFC_MANIFEST) \
    $(DOLBY_VISION_MANIFEST)

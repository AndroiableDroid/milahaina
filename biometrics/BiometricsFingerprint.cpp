...
xiaomi_fingerprint_device_t *getDeviceForVendor(const char *class_name) {
...
xiaomi_fingerprint_device_t *getFingerprintDevice() {
...
xiaomi_fingerprint_device_t* BiometricsFingerprint::openHal() {
    int err;
